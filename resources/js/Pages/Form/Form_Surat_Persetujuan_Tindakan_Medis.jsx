...
export default function Form_Surat_Persetujuan_Tindakan_Medis(props) {
    ...
    const oc_simpan = (e) => {
        ...
        axios.post(window.location.origin+'/form_surat_persetujuan_tindakan_medis/tambah',
            {
            ...
            <div className="flex">
                <div className="w-[25%]">Untuk dilakukan tindakan medis berupa :</div>
                {
                    ...
                    <div className="w-full">
                        <input className="w-[100%] h-[100%] p-0" type="text"
                        name="tindakan_medis"
            ...
            <div className="grid grid-cols-5">
                ...
                <div className="grid col-start-2 col-end-6">
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <div className="w-[40%]">
                            <input className="w-full p-0" type="text" name="alamat"
                            onChange={oc_yg_telah_memberikan}
                            value={get_yg_telah_memberikan.alamat}></input>
                        </div>    
                    </div>
                    }
                    {
